              ...
              <div class="modal-body">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="acc_password" id="accPassword" placeholder="Account Password">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
          ...
          <div class="modal-content">
            ...
            <form id="contactEditForm">
              ...
              <div class="modal-body">              
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="accPassword2">Account Password</label><span class="text-danger error-uname"></span>
                      <input type="text" class="form-control" name="acc_password" id="accPassword2" value="*****" placeholder="Account Password">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="accId2">Account ID</label>
